...
2026-08-20 的 7 模型、3-seed 同口径 smoke 将 TokenFormer 判定为保留：它不是最高 AUC 路线，但在约 159M 参数下给出了最低 seed 方差和有竞争力的 LogLoss，训练成本也处于最低一档。完整协议、数字和限制见 [PCVR Smoke Diagnostics](../benchmark/pcvr-diagnostics.md)。
